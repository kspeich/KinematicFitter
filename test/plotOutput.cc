...
void plotOutput()
{
  ...
  overlayPlots("H->aa->bbtautau BB Invariant Mass (without Kinematic Fit, with SVFit)", "Invariant Mass (GeV)", "Number of Events", svFitFiles, {"Unfitted BB Invariant Mass;1", "Unfitted BB Invariant Mass;1", "Unfitted BB Invariant Mass;1", "Unfitted BB Invariant Mass;1"}, legends, colors);
  overlayPlots("H->aa->bbtautau BB Invariant Mass (with Kinematic Fit, with SVFit)", "Invariant Mass (GeV)", "Number of Events", svFitFiles, {"Fitted BB Invariant Mass;1", "Fitted BB Invariant Mass;1", "Fitted BB Invariant Mass;1", "Fitted BB Invariant Mass;1"}, legends, colors);
