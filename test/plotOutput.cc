...
void plotOutput()
{
  ...
  std::vector<TFile*> svFitFiles = {svFitSignal, svFitDYJets, svFitTTLeptonic, svFitTTSemiLeptonic};
  std::vector<std::string> legends = {"H->aa->bbtautau Signal", "DY Jets", "TT Leptonic", "TT Semi-Leptonic"};
  std::vector<Color_t> colors = {kBlue, kRed, kGreen, kGray};

  plotKinematics(recoSignal, "H->aa->bbtautau");

  overlayPlots("H->aa->bbtautau Tau Tau Invariant Mass (with SVFit)", "Invariant Mass (GeV)", "Number of Events", {svFitSignal, svFitSignal}, {"Unfitted Tau Tau Invariant Mass;1", "Fitted Tau Tau Invariant Mass;1"}, {"Before Kinematic Fit", "After Kinematic Fit"}, {kBlue, kRed});
  overlayPlots("H->aa->bbtautau BB Invariant Mass (with SVFit)", "Invariant Mass (GeV)", "Number of Events", {svFitSignal, svFitSignal}, {"Unfitted BB Invariant Mass;1", "Fitted BB Invariant Mass;1"}, {"Before Kinematic Fit", "After Kinematic Fit"}, {kBlue, kRed});

  overlayPlots("H->aa->bbtautau All-Particle Invariant Mass (without Kinematic Fit, with SVFit)", "Invariant Mass (GeV)", "Number of Events", svFitFiles, {"Unfitted All-Particle Invariant Mass;1", "Unfitted All-Particle Invariant Mass;1", "Unfitted All-Particle Invariant Mass;1", "Unfitted All-Particle Invariant Mass;1"}, legends, colors);
  overlayPlots("H->aa->bbtautau All-Particle Invariant Mass (with Kinematic Fit, with SVFit)", "Invariant Mass (GeV)", "Number of Events", svFitFiles, {"Fitted All-Particle Invariant Mass;1", "Fitted All-Particle Invariant Mass;1", "Fitted All-Particle Invariant Mass;1", "Fitted All-Particle Invariant Mass;1"}, legends, colors);
  overlayPlots("H->aa->bbtautau All-Particle Invariant Mass for Events with 1 b-jet (without Kinematic Fit, with SVFit)", "Invariant Mass (GeV)", "Number of Events", svFitFiles, {"Unfitted All-Particle Invariant Mass (1 b-jet);1", "Unfitted All-Particle Invariant Mass (1 b-jet);1", "Unfitted All-Particle Invariant Mass (1 b-jet);1", "Unfitted All-Particle Invariant Mass (1 b-jet);1"}, legends, colors);
  overlayPlots("H->aa->bbtautau All-Particle Invariant Mass for Events with 1 b-jet (with Kinematic Fit, with SVFit)", "Invariant Mass (GeV)", "Number of Events", svFitFiles, {"Fitted All-Particle Invariant Mass (1 b-jet);1", "Fitted All-Particle Invariant Mass (1 b-jet);1", "Fitted All-Particle Invariant Mass (1 b-jet);1", "Fitted All-Particle Invariant Mass (1 b-jet);1"}, legends, colors);
  overlayPlots("H->aa->bbtautau All-Particle Invariant Mass for Events with 2 b-jets (without Kinematic Fit, with SVFit)", "Invariant Mass (GeV)", "Number of Events", svFitFiles, {"Unfitted All-Particle Invariant Mass (2 b-jets);1", "Unfitted All-Particle Invariant Mass (2 b-jets);1", "Unfitted All-Particle Invariant Mass (2 b-jets);1", "Unfitted All-Particle Invariant Mass (2 b-jets);1"}, legends, colors);
  overlayPlots("H->aa->bbtautau All-Particle Invariant Mass for Events with 2 b-jets (with Kinematic Fit, with SVFit)", "Invariant Mass (GeV)", "Number of Events", svFitFiles, {"Fitted All-Particle Invariant Mass (2 b-jets);1", "Fitted All-Particle Invariant Mass (2 b-jets);1", "Fitted All-Particle Invariant Mass (2 b-jets);1", "Fitted All-Particle Invariant Mass (2 b-jets);1"}, legends, colors);

  overlayPlots("H->aa->bbtautau Tau Tau Invariant Mass (without Kinematic Fit, with SVFit)", "Invariant Mass (GeV)", "Number of Events", svFitFiles, {"Unfitted Tau Tau Invariant Mass;1", "Unfitted Tau Tau Invariant Mass;1", "Unfitted Tau Tau Invariant Mass;1", "Unfitted Tau Tau Invariant Mass;1"}, legends, colors);
  overlayPlots("H->aa->bbtautau Tau Tau Invariant Mass (with Kinematic Fit, with SVFit)", "Invariant Mass (GeV)", "Number of Events", svFitFiles, {"Fitted Tau Tau Invariant Mass;1", "Fitted Tau Tau Invariant Mass;1", "Fitted Tau Tau Invariant Mass;1", "Fitted Tau Tau Invariant Mass;1"}, legends, colors);
  overlayPlots("H->aa->bbtautau Tau Tau Invariant Mass for Events with 1 b-jet (without Kinematic Fit, with SVFit)", "Invariant Mass (GeV)", "Number of Events", svFitFiles, {"Unfitted Tau Tau Invariant Mass (1 b-jet);1", "Unfitted Tau Tau Invariant Mass (1 b-jet);1", "Unfitted Tau Tau Invariant Mass (1 b-jet);1", "Unfitted Tau Tau Invariant Mass (1 b-jet);1"}, legends, colors);
  overlayPlots("H->aa->bbtautau Tau Tau Invariant Mass for Events with 1 b-jet (with Kinematic Fit, with SVFit)", "Invariant Mass (GeV)", "Number of Events", svFitFiles, {"Fitted Tau Tau Invariant Mass (1 b-jet);1", "Fitted Tau Tau Invariant Mass (1 b-jet);1", "Fitted Tau Tau Invariant Mass (1 b-jet);1", "Fitted Tau Tau Invariant Mass (1 b-jet);1"}, legends, colors);
  overlayPlots("H->aa->bbtautau Tau Tau Invariant Mass for Events with 2 b-jets (without Kinematic Fit, with SVFit)", "Invariant Mass (GeV)", "Number of Events", svFitFiles, {"Unfitted Tau Tau Invariant Mass (2 b-jets);1", "Unfitted Tau Tau Invariant Mass (2 b-jets);1", "Unfitted Tau Tau Invariant Mass (2 b-jets);1", "Unfitted Tau Tau Invariant Mass (2 b-jets);1"}, legends, colors);
  overlayPlots("H->aa->bbtautau Tau Tau Invariant Mass for Events with 2 b-jets (with Kinematic Fit, with SVFit)", "Invariant Mass (GeV)", "Number of Events", svFitFiles, {"Fitted Tau Tau Invariant Mass (2 b-jets);1", "Fitted Tau Tau Invariant Mass (2 b-jets);1", "Fitted Tau Tau Invariant Mass (2 b-jets);1", "Fitted Tau Tau Invariant Mass (2 b-jets);1"}, legends, colors);

  overlayPlots("H->aa->bbtautau BB Invariant Mass (without Kinematic Fit, with SVFit)", "Invariant Mass (GeV)", "Number of Events", svFitFiles, {"Unfitted Tau Tau Invariant Mass;1", "Unfitted Tau Tau Invariant Mass;1", "Unfitted Tau Tau Invariant Mass;1", "Unfitted Tau Tau Invariant Mass;1"}, legends, colors);
  overlayPlots("H->aa->bbtautau BB Invariant Mass (with Kinematic Fit, with SVFit)", "Invariant Mass (GeV)", "Number of Events", svFitFiles, {"Fitted Tau Tau Invariant Mass;1", "Fitted Tau Tau Invariant Mass;1", "Fitted Tau Tau Invariant Mass;1", "Fitted Tau Tau Invariant Mass;1"}, legends, colors);

  overlayPlots("H->aa->bbtautau Tau Tau Invariant Mass (without Kinematic Fit)", "Invariant Mass (GeV)", "Number of Events", {recoSignal, svFitSignal}, {"Unfitted Tau Tau Invariant Mass;1", "Unfitted Tau Tau Invariant Mass;1"}, {"Without SVFit", "With SVFit"}, {kBlue, kRed});
...
void plotKinematics(TFile* file, std::string process, bool svFit)
{
  ...
  if (svFit)
  {
    suffix = "(with SVFit Di-Tau)";
  }

  overlayPlots(process + " Final State Transverse Energy " + suffix, "Transverse Energy (GeV)", "Number of Events", {file, file}, {"Unfitted Transverse Energy;1", "Fitted Transverse Energy;1"}, {"Before Kinematic Fit", "After Kinematic Fit"}, {kBlue, kRed});
  overlayPlots(process + " Final State Pseudorapidity " + suffix, "Pseudorapidity", "Number of Events", {file, file}, {"Unfitted Eta;1", "Fitted Eta;1"}, {"Before Kinematic Fit", "After Kinematic Fit"}, {kBlue, kRed});
  overlayPlots(process + " Final State Phi " + suffix, "Phi", "Number of Events", {file, file}, {"Unfitted Phi;1", "Fitted Phi;1"}, {"Before Kinematic Fit", "After Kinematic Fit"}, {kBlue, kRed});
}
...
void plotInvariantMasses(TFile* signalKinFitHistograms, TFile* dyJetsKinFitHistograms, TFile* ttLeptonicKinFitHistograms, TFile* ttSemiLeptonicKinFitHistograms, bool svFit)
{
  ...
  overlayPlots("H->aa->bbtautau All-Particle Invariant Mass " + suffix, "Invariant Mass (GeV)", "Number of Events", {signalKinFitHistograms, signalKinFitHistograms}, {"Unfitted All-Particle Invariant Mass;1", "Fitted All-Particle Invariant Mass;1"}, {"Before Kinematic Fit", "After Kinematic Fit"}, {kBlue, kRed});
  ...
  overlayPlots("DY Jets All-Particle Invariant Mass " + suffix, "Invariant Mass (GeV)", "Number of Events", {dyJetsKinFitHistograms, dyJetsKinFitHistograms}, {"Unfitted All-Particle Invariant Mass;1", "Fitted All-Particle Invariant Mass;1"}, {"Before Kinematic Fit", "After Kinematic Fit"}, {kBlue, kRed});
  ...
  overlayPlots("TT Leptonic All-Particle Invariant Mass " + suffix, "Invariant Mass (GeV)", "Number of Events", {ttLeptonicKinFitHistograms, ttLeptonicKinFitHistograms}, {"Unfitted All-Particle Invariant Mass;1", "Fitted All-Particle Invariant Mass;1"}, {"Before Kinematic Fit", "After Kinematic Fit"}, {kBlue, kRed});
  ...
  overlayPlots("TT Semi-Leptonic All-Particle Invariant Mass " + suffix, "Invariant Mass (GeV)", "Number of Events", {ttSemiLeptonicKinFitHistograms, ttSemiLeptonicKinFitHistograms}, {"Unfitted All-Particle Invariant Mass;1", "Fitted All-Particle Invariant Mass;1"}, {"Before Kinematic Fit", "After Kinematic Fit"}, {kBlue, kRed});
  ...
  std::vector<Color_t> colors = {kBlue, kRed, kGreen, kGray};
  overlayPlots("Tau Tau Invariant Mass " + suffix, "Invariant Mass (GeV)", "Number of Events", files, {"Unfitted Tau Tau Invariant Mass;1", "Unfitted Tau Tau Invariant Mass;1", "Unfitted Tau Tau Invariant Mass;1", "Unfitted Tau Tau Invariant Mass;1"}, legends, colors);
  overlayPlots("BB Invariant Mass " + suffix, "Invariant Mass (GeV)", "Number of Events", files, {"Unfitted BB Invariant Mass;1", "Unfitted BB Invariant Mass;1", "Unfitted BB Invariant Mass;1", "Unfitted BB Invariant Mass;1"}, legends, colors);
  overlayPlots("Kinematic Fitted Tau Tau Invariant Mass " + suffix, "Invariant Mass (GeV)", "Number of Events", files, {"Fitted Tau Tau Invariant Mass;1", "Fitted Tau Tau Invariant Mass;1", "Fitted Tau Tau Invariant Mass;1", "Fitted Tau Tau Invariant Mass;1"}, legends, colors);
  overlayPlots("Kinematic Fitted BB Invariant Mass " + suffix, "Invariant Mass (GeV)", "Number of Events", files, {"Fitted BB Invariant Mass;1", "Fitted BB Invariant Mass;1", "Fitted BB Invariant Mass;1", "Fitted BB Invariant Mass;1"}, legends, colors);
...
void compareInvariantMasses(TFile* signalKinFitHistograms, TFile* svFitSignalKinFitHistograms, TFile* dyJetsKinFitHistograms, TFile* svFitDYJetsKinFitHistograms, TFile* ttLeptonicKinFitHistograms, TFile* svFitTTLeptonicKinFitHistograms, TFile* ttSemiLeptonicKinFitHistograms, TFile* svFitTTSemiLeptonicKinFitHistograms, bool kinFit, int numBJets)
{
  ...
  std::vector<std::string> allHistNames = {"Unfitted All-Particle Invariant Mass" + histNamesModifier + ";1", "Unfitted All-Particle Invariant Mass" + histNamesModifier + ";1"};
  ...
  if (kinFit)
  {
    ...
    allHistNames = {"Fitted All-Particle Invariant Mass" + histNamesModifier + ";1", "Fitted All-Particle Invariant Mass" + histNamesModifier + ";1"};
  }
  ...
  overlayPlots("H->aa->bbtautau All-Particle Invariant Mass " + suffixPrefix + suffix, "Invariant Mass (GeV)", "Number of Events", {signalKinFitHistograms, svFitSignalKinFitHistograms}, allHistNames, {"Reco", "SVFit"}, {kBlue, kRed});
  ...
  overlayPlots("DY Jets All-Particle Invariant Mass " + suffixPrefix + suffix, "Invariant Mass (GeV)", "Number of Events", {dyJetsKinFitHistograms, svFitDYJetsKinFitHistograms}, allHistNames, {"Reco", "SVFit"}, {kBlue, kRed});
  ...
  overlayPlots("TT Leptonic All-Particle Invariant Mass " + suffixPrefix + suffix, "Invariant Mass (GeV)", "Number of Events", {ttLeptonicKinFitHistograms, svFitTTLeptonicKinFitHistograms}, allHistNames, {"Reco", "SVFit"}, {kBlue, kRed});
  ...
  overlayPlots("TT Semi-Leptonic All-Particle Invariant Mass " + suffixPrefix + suffix, "Invariant Mass (GeV)", "Number of Events", {ttSemiLeptonicKinFitHistograms, svFitTTSemiLeptonicKinFitHistograms}, allHistNames, {"Reco", "SVFit"}, {kBlue, kRed});
}
